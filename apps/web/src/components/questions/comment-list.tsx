...
type Props = {
  comments: Comment[];
  isFormOpen: boolean;
  /** `false` quando o usuário está logado mas não tem reputação suficiente para comentar. */
  canComment: boolean;
...
export function CommentList({
  ...
  return (
    <div className="mt-3 space-y-2 border-t border-zinc-200 pt-3 text-sm">
      ...
      {!canComment ? (
        <p className="text-zinc-400">You need 50 reputation to comment.</p>
      ) : isFormOpen ? (
        <>
